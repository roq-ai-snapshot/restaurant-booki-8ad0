  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of dining with Restaurant Booking Engine - A seamless platform for table reservations and restaurant management, tailored to enhance your dining and business experience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of dining with Restaurant Booking Engine - A seamless platform for table reservations and restaurant management, tailored to enhance your dining and business experience.`}
            </Text>
            <Box
